...
use graphics::iced_widget::{column, row, Column, Container, Scrollable};
use graphics::iced_winit::{
    core::{Color, Element, Length},
    style::Theme,
};
...
impl Ui for ItemUI {
    ...
    fn update(&mut self, msg: Message) -> Option<Box<dyn Ui<Message = Message>>> {
        match msg {
