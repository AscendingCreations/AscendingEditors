...
impl ShopUiGeneric {
    pub fn layout(&self) -> Element<Message> {
        let row0 = row![
            ...
            "Max Shop Item",
            self.max_shop_item
                .view(1, 0, 20, 1, Message::GenericInput, None),
        ]
        .spacing(12)
        ...
        let row1 = row![
            ...
            "Index:",
            self.item_index
                .view(2, 0, MAX_ITEMS as u16, 1, Message::GenericInput, None),
            "Amount:",
            self.item_amount
                .view(3, 0, u16::MAX, 1, Message::GenericInput, None),
            "Price:",
            self.item_price
                .view(1, 0, u64::MAX, 1, Message::GenericInput64, None),
        ]
        .spacing(5);
